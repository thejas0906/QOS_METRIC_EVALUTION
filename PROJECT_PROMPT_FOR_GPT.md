...
## 4. Empirical Results Generated by the Simulation (WS-DREAM Benchmark #1)

### 4.1 Prediction Accuracy (RMSE & MAE)
Evaluated on the $339 \times 5,825$ real-world WS-DREAM QoS benchmark:
| QoS Attribute | Team A (BiasedMF) RMSE | Team A (BiasedMF) MAE | Team B (GraphSAGE) RMSE | Team B (GraphSAGE) MAE |
| :--- | :---: | :---: | :---: | :---: |
| Availability | 0.3267 | 0.1882 | **0.0924** | **0.0732** |
| Latency (ms) | **529.4553** | **257.6280** | 632.0683 | 263.8560 |
| Reliability | 0.3232 | 0.1875 | **0.1089** | **0.0886** |
| Response Time (s) | **1.7901** | **0.8733** | 1.9301 | 0.9637 |
| Throughput (kbps) | **105.3586** | 50.4362 | 120.2205 | **46.7513** |
...
- **Average Invocation Cost (Team B Cost-Aware)**: **$0.1575** per call
- **Average Invocation Cost (Baseline QoS-Only)**: **$0.5403** per call
- **Cost Savings**: **70.85% reduction**
- **Cost-Performance Ratio**: **3.0341**
- **Mean Utility Score**: **0.3435**

### 4.4 Inductive Cold-Start Robustness (Unseen Users & Services)
- **Cold Users (N = 33 unseen)**: Availability RMSE = **0.5392**, Reliability RMSE = **0.5104**, Response Time RMSE = **2.0393**
- **Cold Services (N = 582 unseen)**: Availability RMSE = **0.5698**, Reliability RMSE = **0.5391**, Response Time RMSE = **2.1992**

### 4.5 Three-Paradigm Trade-off Comparison (QoS-Only vs. Cost vs. Confidence)
| Paradigm | $\alpha$ (QoS) | $\beta$ (Cost) | $\gamma$ (Conf) | Prec@10 | NDCG@10 | Avg Cost ($) | Cost Savings | CP Ratio | Avg Confidence | Coverage |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **Paradigm A (QoS-Only)** | 1.0 | 0.0 | 0.0 | 0.1985 | 0.6720 | $0.5043 | 0.00% | 1.3208 | 0.9492 | 19.06% |
| **Paradigm B (QoS + Cost)** | 0.7 | 0.3 | 0.0 | 0.0702 | 0.4269 | $0.0827 | 83.60% | 4.7482 | 0.7007 | 2.30% |
| **Paradigm C (QoS + Cost + Conf)** | 0.5 | 0.3 | 0.2 | **0.1900** | **0.6352** | **$0.0705** | **86.01%** | **5.2171** | **0.9841** | 1.29% |
